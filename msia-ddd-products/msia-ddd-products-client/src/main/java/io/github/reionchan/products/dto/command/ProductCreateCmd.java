...
import static io.github.reionchan.products.consts.ProductsBizScenarioCst.PRODUCTS_CREATE_USE_CASE;
 ...
 **/
@Data
@Schema(name = "ProductCreateCmd", description = "产品数据传输对象")
public class ProductCreateCmd extends Command {

    private static final long serialVersionUID = 1L;

    private BizScenario bizScenario = BizScenario.valueOf(PRODUCTS_BIZ_ID, PRODUCTS_CREATE_USE_CASE);
