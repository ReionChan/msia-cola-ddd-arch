 ...
 **/
@Data
@Schema(name = "ProductModifyCmd", description = "产品数据传输对象")
public class ProductModifyCmd extends Command {

    private static final long serialVersionUID = 1L;

    private BizScenario bizScenario = BizScenario.valueOf(PRODUCTS_BIZ_ID, PRODUCTS_MODIFY_USE_CASE);
