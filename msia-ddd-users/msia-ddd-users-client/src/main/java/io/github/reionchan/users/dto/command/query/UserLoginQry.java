...
import static io.github.reionchan.users.consts.UsersBizScenarioCst.USER_LOGIN_USE_CASE;
...
public class UserLoginQry extends Query {

    private static final long serialVersionUID = 1L;

    private BizScenario bizScenario = BizScenario.valueOf(USER_BIZ_ID, USER_LOGIN_USE_CASE);
